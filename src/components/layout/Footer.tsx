          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="/documentation" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                    {t.documentation}
                  </a>
                </li>
                <li>
                  <a href="/support" className="text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                    {t.support}
                  </a>
                </li>
                <li>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex items-center space-x-4 mt-4 md:mt-0">
                <span className="text-xs text-gray-400 dark:text-gray-500">
                  {language === 'fr' ? 'Développé avec' : 'Built with'} ❤️ {language === 'fr' ? 'pour l\'environnement' : 'for the environment'}
                </span>
              </div>
            </div>
          </div>
