  ...
  const [datasets] = useState<Dataset[]>([
    {
      ...
      description:
        "Images satellite Sentinel-2 avec correction atmosphérique pour l'analyse de la végétation",
      type: "satellite",
    ...
    },
    {
      ...
      description:
        "Données de réanalyse climatique ERA5 avec variables météorologiques complètes",
      type: "climate",
      source: "ECMWF",
    ...
    },
    {
      ...
      description:
        "Indices de végétation NDVI et EVI dérivés des données MODIS",
      type: "vegetation",
      source: "NASA/USGS",
    ...
    },
    {
      ...
      description:
        "Données de précipitations CHIRPS avec résolution quotidienne",
      type: "climate",
      source: "UCSB/USGS",
        ...
        <div className="responsive-card bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="responsive-flex items-center justify-between gap-4">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400">
              ...
              {filteredDatasets.length > 1 ? "s" : ""} trouvé
              ...
              <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="flex items-center space-x-2">
                  <button className="p-1.5 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-300 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700">
                    ...
                    <span className="sr-only">EyeBtn</span>
                  </button>
                  {dataset.status === "available" && (
                    <button className="p-1.5 text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 rounded-md hover:bg-indigo-50 dark:hover:bg-indigo-900/20">
                      ...
                      <span className="sr-only">ArrowDownTrayBtn</span>
                    </button>
                  )}
                </div>
              </div>
