              ...
              <div className="responsive-chart flex items-center justify-center text-gray-500 dark:text-gray-400 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg">
                <div className="text-center">
                  ...
                  <p className="text-sm mt-1">
                    {regionSummaries.reduce(
                      (sum, r) => sum + r.activeStations,
                      0
                    )}{" "}
                    stations actives
                  </p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-orange-700 dark:text-orange-300 text-sm mt-1">
                  Températures élevées détectées dans les régions du Sahel et du
                  Nord. 3 stations signalent des conditions critiques.
                </p>
              </div>
            </div>
          </Alert>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-blue-700 dark:text-blue-300 text-sm mt-1">
                  ...
                  stations sur{" "}
                  {regionSummaries.reduce((sum, r) => sum + r.totalStations, 0)}{" "}
                  sont opérationnelles. Couverture globale: 85% du territoire
                  WASCAL.
                </p>
              </div>
            </div>
