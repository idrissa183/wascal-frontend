        ...
        {selectedStationData && (
          <>
              ...
              <div className="responsive-flex items-center justify-between">
                <div>
                  ...
                  <p className="text-blue-100 text-xs mt-1">
                    Dernière mise à jour: {formatTime(selectedStationData.lastUpdate)}
                  </p>
                </div>
            ...
            <div className="responsive-grid">
              ...
              <div className="responsive-card bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                <div className="flex items-center space-x-3">
                  <WindIcon className="w-8 h-8 text-gray-500" />
                  <div>
              ...
              <div className="responsive-card bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Index UV</p>
                    <p className="text-2xl font-bold text-gray-900 dark:text-white">
                      {selectedStationData.currentWeather.uvIndex}
                    </p>
                    <p className={`text-xs font-medium ${getUVLevel(selectedStationData.currentWeather.uvIndex).color}`}>
                      {getUVLevel(selectedStationData.currentWeather.uvIndex).level}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-orange-700 dark:text-orange-300 text-sm mt-1">
                      Température critique détectée ({selectedStationData.currentWeather.temperature}°C).
            ...
            {selectedStationData.currentWeather.windSpeed > 25 && (
              <Alert variant="warning">
                <div className="flex items-start space-x-3">
                  <WindIcon className="w-5 h-5 text-orange-600 mt-0.5" />
                  <div>
                    <h4 className="font-medium text-orange-900 dark:text-orange-200">
                      Alerte Vent Fort
                    </h4>
                    <p className="text-orange-700 dark:text-orange-300 text-sm mt-1">
                      Vents forts détectés ({selectedStationData.currentWeather.windSpeed} km/h).
              ...
              {weatherStations.map((station) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs">
                    ...
                    <div className="flex items-center space-x-1">
                      <WindIcon className="w-3 h-3 text-gray-500" />
                      <span className="text-gray-600 dark:text-gray-400">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-blue-700 dark:text-blue-300 text-sm mt-1">
                ...
                Dernière actualisation: {formatTime(lastRefresh.toISOString())}.
              </p>
            </div>
          </div>
        </Alert>
